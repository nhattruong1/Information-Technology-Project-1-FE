    ...
    return (
      <div>
        <header className="header-nav">
          <section className="top-header-nav">
            <div className="top-header-nav-left">
              {" "}
              <a href="#" className="pd-l bd ct">
                Join Us
              </a>
              <a href="#" className="pd-l bd ct">
                <svg
            ...
            <div className="top-header-nav-right">
              {" "}
              <a href="#" className="pd-r r-hover ct">
              ...
              <div className="pd-r ct" style={{ display: "flex" }}>
                ...
                <p style={{ margin: "0 0 0 10px" }}>Vietnam</p>
              </div>
            </div>
          </section>
          <section className="header-nav-main">
            ...
            <div className="header-nav-main-menu">
              <ul>
                ...
                <li className="r-hover">SALE</li>
              </ul>
            </div>
            <div className="header-nav-main-search ct-l">
